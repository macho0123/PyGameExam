...
def indicatePosition(fret, string):
    ...
    if (fret > 0):
        ...
        indicatorHitbox = pygame.rect.Rect(-50 + fret * indicatorWidth + 10,
                                           -indicatorWidth + display_height - string * indicatorHeight + 10,
    ...
    if (fret == 0):
        ...
        indicator.fill((255, 255, 255, 128))  # notice the alpha value in the color
        screen.blit(indicator, (-50 + fret * indicatorWidth + indicatorWidth / 1.1,
                                -indicatorWidth + display_height - string * indicatorHeight + 10))
